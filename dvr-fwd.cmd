...
system rm -f dvr-fifo.y4m
system mkfifo dvr-fifo.y4m
system rm -f dvr-fifo.wav
system mkfifo dvr-fifo.wav

config y4mout output dvr-fifo.y4m
config wo output dvr-fifo.wav

system ../libtheora-1.2.0alpha1/examples/encoder_example  dvr-fifo.y4m -V 140 | tee cap-dvr.ogv |  oggfwd localhost 8000 hackme /dvr.ogv &

#  ... dvr-fifo.wav  file.y4m  -A 20 ...

#system cat dvr-fifo.y4m > /dev/null &
system cat dvr-fifo.wav > /dev/null &
