...
typedef enum {
  ...
  IMAGE_TYPE_PGM,
  IMAGE_TYPE_PPM,
  IMAGE_TYPE_YUVYUV422P,		/* raw dumps from V4L2Capture module */
  IMAGE_TYPE_O511,
...
extern YUVYUV422P_buffer *YUVYUV422P_buffer_new(int width, int height, Image_common *c);
extern YUVYUV422P_buffer *YUVYUV422P_buffer_from(uint8_t *data, int len, Image_common *c);
extern void YUVYUV422P_buffer_discard(YUVYUV422P_buffer *y422p);
extern YUVYUV422P_buffer *YUVYUV422P_copy(YUVYUV422P_buffer *y422p, int x, int y, int width, int height);
extern YUVYUV422P_buffer *YUVYUV422P_clone(YUVYUV422P_buffer *y422p);
extern void YUVYUV422P_paste(YUVYUV422P_buffer *dest, YUVYUV422P_buffer *src, int x, int y, int width, int height);
extern RGB3_buffer *YUVYUV422P_to_RGB3(YUVYUV422P_buffer *y422p);
extern BGR3_buffer *YUVYUV422P_to_BGR3(YUVYUV422P_buffer *y422p);
...
extern Y420P_buffer *YUVYUV422P_to_Y420P(YUVYUV422P_buffer *y422p);

extern YUVYUV422P_buffer *RGB3_toYUVYUV422P(RGB3_buffer *rgb);
extern YUVYUV422P_buffer *BGR3_toYUVYUV422P(BGR3_buffer *bgr);
