...
static void YUVYUV422P_handler(Instance *pi, void *data)
{
  ...
  if (!priv->use_420) {
    ...
    y420p = YUVYUV422P_to_Y420P(y422p_in);
...
static void RGB3_handler(Instance *pi, void *data)
{
  ...
  YUVYUV422P_buffer *y4m = RGB3_toYUVYUV422P(rgb3_in);

  YUVYUV422P_handler(pi, y4m);
...
static void BGR3_handler(Instance *pi, void *data)
{
  ...
  YUVYUV422P_buffer *y4m = BGR3_toYUVYUV422P(bgr3_in);
