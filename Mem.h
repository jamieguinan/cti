...
extern void *_Mem_malloc(int size, const char *func, int line);
extern void *_Mem_calloc(int count, int size, const char *func, int line);
extern void *_Mem_realloc(void *ptr, int newsize, const char *func, int line);
...
#define Mem_malloc(x) _Mem_malloc(x, __func__, __LINE__)
#define Mem_calloc(n, x) _Mem_calloc(n, x, __func__, __LINE__)
#define Mem_realloc(p, x) _Mem_realloc(p, x, __func__, __LINE__)
