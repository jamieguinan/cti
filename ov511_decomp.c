 ...
 *
 * Standalone hacks Copyright (C) 2008 Jamie Guinan <guinan@bluebutton.com>
 *
...
#define maybe_static /* not static */
...
struct ov51x_decomp_ops ov511_decomp_ops = {
	.decomp_400 =	ov511_decomp_400,
	.decomp_420 =	ov511_decomp_420,
};
#endif
...
static unsigned char input[80000];
static unsigned char output[(640*480*3)/2];
static unsigned char temp[(640*480*3)/2];
